...
exports = module.exports = function (txn, res, params) {
  ...
  var to = txn.locals.webMessaging.targetOrigin;
...
exports.validate = function(txn) {
  var webMessaging = (txn.locals && txn.locals.webMessaging) || {};
  if (!webMessaging.targetOrigin) { throw new Error('Unable to post message for OAuth 2.0 transaction'); }
};
