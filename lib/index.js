...
// TODO: need var on messageTargetWindow
...
'console.log(evt.source.document);' +
          'switch (evt.data.type) {' +
            'case "relay_response":' +  // 
              'messageTargetWindow = evt.source.document.getElementById(webMessageRequest["web_message_target"]);' +
'console.log("MTR");' +
